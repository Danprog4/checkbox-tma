  ...
  return (
    <div className="bg-[#262626] rounded-[7px] p-4 flex items-center justify-between">
      <div className="flex items-center gap-3">
        <div
          className={`w-8 h-8 rounded-full flex items-center ${partner.category.length >= 3 ? "text-xs" : "text-xs"} justify-center text-[#20A261] font-bold border-2 border-[#20A261]`}>
